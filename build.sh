...
cmd="python /mnt/c/Users/Andrew/Programming/pretext/pretext/pretext -f html-incremental -c all -d published/tourcs -vvv -p publication/publication-runestone.xml source/main.ptx -r pointers-aggregation -x debug.rs.dev yes html.build-preview yes"
