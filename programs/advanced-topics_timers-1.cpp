...
class VideoGame : public ActionListener {
  ...
  public:
    VideoGame() {
        ...
        // JFrame frame; //Assuming JFrame is a class and that the constructor
        // has no arguments.
        // frame.setDefaultCloseOperation(JFrame::EXIT_ON_CLOSE);
        // //Assuming EXIT_ON_CLOSE is defined appropriately.
        // frame.add(drawing); frame.pack(); frame.setVisible(true);
    }
